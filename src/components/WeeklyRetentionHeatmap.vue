...
const option = ref({
  ...
  grid: {
    height: '60%', // Reducido de 70% para dar más espacio
    top: '15%',    // Aumentado de 10% para dar más espacio arriba
    left: '15%',   // Aumentado de 10% para dar más espacio a la izquierda
    right: '10%'
  },
  xAxis: {
    type: 'category',
    ...
    axisLabel: {
      color: '#A9DBB5',
      fontSize: 12,
      margin: 10 // Aumentar margen para mejor separación
    },
    splitArea: {
      show: true,
      areaStyle: {
  ...
  yAxis: {
    type: 'category',
    data: ['Usuario 1','Usuario 2','Usuario 3','Usuario 4','Usuario 5'], // Nombres más descriptivos
    splitArea: { show: true },
    axisLine: {
      lineStyle: {
        color: 'rgba(169, 219, 181, 0.3)'
  ...
  visualMap: {
    ...
    orient: 'horizontal',
    left: 'center',
    bottom: '5%', // Aumentado de 0% para dar más espacio
    itemWidth: 15,
    itemHeight: 120,
    textStyle: {
      color: '#A9DBB5'
...
.chart-content {
  flex: 1;
  position: relative;
  min-height: 300px; /* Altura mínima para evitar que se achate */
}
...
@media (min-width: 992px) {
  .chart-content {
    min-height: 350px; /* Mayor altura en pantallas grandes */
  }
}
</style>